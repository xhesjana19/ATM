...
namespace ATM.Core.Services.Cryptography
{
    /// <summary>
    /// Represents the default encryption service.
    /// </summary>
    public class EncryptionService : IEncryptionService
    {
        private readonly string _encryptionKey = "bd17d0b530b949b7a72e6918861e3c13";
        private readonly string _encryptionFormat = "SHA512";
        ...
        {
            return CreateHash(Encoding.UTF8.GetBytes(password), _encryptionFormat);
        }
        ...
        /// <returns>Password hash.</returns>
        public virtual string CreatePasswordHash(string password, string passwordFormat)
        {
            return CreateHash(Encoding.UTF8.GetBytes(password), passwordFormat);
        }
